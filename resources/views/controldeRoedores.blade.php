        ...
        <div class="header-top">
            <div class="auto-container clearfix">
                <div class="top-left clearfix">
                    <div class="text"><span class="icon flaticon-call-answer"></span> Necesitas ayuda? Contactanos ahora : <a href="#" class="number">55 63 54 58 23</a></div>
        	...
        	<div class="row clearfix">
                ...
                <div class="content-side col-xl-9 col-lg-8 col-md-12 col-sm-12">
                	<div class="services-detail">
						<div class="inner-box">
							<div class="bold-text">La integración de tecnologías avanzadas en el manejo de roedores cerrará el ciclo de control enfocándose rigurosamente en la prevención industrial.</div>
							<div class="text">
								<p>Implementamos estrategias de control biológico y físico de mutuo beneficio para asegurar una protección proactiva y permanente en su planta. Hoy en día, la evolución hacia un nuevo estándar operativo derivado de las exigencias de inocuidad alimentaria se encamina hacia soluciones de monitoreo digital y reportes completamente auditables. Los registros de comportamiento generados en tiempo real ofrecen múltiples puntos de análisis para la toma de decisiones correctivas inmediatas.</p>
								<p>Hoy en día, la evolución hacia un nuevo estándar operativo derivado de las exigencias de inocuidad alimentaria se encamina hacia soluciones de monitoreo digital y reportes completamente auditables. Los registros de comportamiento generados en tiempo real ofrecen múltiples puntos de análisis para la toma de decisiones correctivas inmediatas.</p>
								<!-- Two Column -->
								<div class="two-column">
									<div class="row clearfix">
										<div class="column col-lg-4 col-md-4 col-sm-12">
											<div class="image">
												<img src="{{ asset('images/resource/service-16.jpg') }}" alt="" />
											</div>
											<div class="image">
												<img src="{{ asset('images/resource/service-17.jpg') }}" alt="" />
											</div>
										</div>
										<div class="content-column col-lg-8 col-md-8 col-sm-12">
											<div class="inner-column">
												<h3>Estamos dedicados al control con excelencia y nos enfocamos estrictamente en la calidad del servicio.</h3>
												<p>Sinergizamos por completo cada plan de trabajo mediante la inspección exhaustiva de nichos críticos y áreas perimetrales. Cultivamos profesionalmente una atención personalizada uno a uno con ideas robustas basadas en el análisis de riesgos geográficos. Innovamos dinámicamente nuestros métodos de exclusión física para ofrecer un servicio de sanidad ambiental con la más alta tecnología disponible.</p>
												<p>Innovamos de manera objetiva la distribución de dispositivos de captura en plataformas paralelas de control. Predominamos holísticamente con procedimientos de prueba extensibles para asegurar cadenas de suministro confiables y libres de contaminación.</p>
											</div>
										</div>
									</div>
								</div>
								<h4>El mejor servicio de control de roedores en su área local</h4>
								<ul class="list-style-four">
									<li>-   Soluciones completas para plantas de producción, almacenes u oficinas.</li>
									<li>-   Consultoría y análisis de riesgos sanitarios adaptados a su presupuesto y necesidades específicas.</li>
									<li>-   Reestructuración o refuerzo de los cordones sanitarios en sus instalaciones.</li>
									<li>-   Colocación de trampas de captura múltiple y cebaderos inviolables para crear un ambiente protegido, limpio y libre de fauna nociva.</li>
									<li>-   Reestructuración o refuerzo de los cordones sanitarios en sus instalaciones.</li>
								</ul>
